...
public class BaseController : MonoBehaviour
{
    ...
    public void UpwardMovement(){ MoveUp(); }
    public void NormalMovement() { MoveNormal(); }
    public void DownwardMovement() { MoveDown(); }
    public void RightTurnMovement() { MoveRight(); }
    public void LeftTurnMovement() { MoveLeft(); }
    public void StraightMovement() { MoveStraight(); }
}
