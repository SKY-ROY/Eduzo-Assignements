...
{
    public bool onScreenControls = false;
    ...
    private GameObject onScreenControlAssembly;
    ...
    void Start()
    {
        ...
        onScreenControlAssembly = GameObject.Find("On Screen Controls Assembly");

        if(onScreenControls)
        {
            onScreenControlAssembly.SetActive(true);
            AssignOnScreenControlReference();
        }
        else
        {
            onScreenControlAssembly.SetActive(false);
        }
